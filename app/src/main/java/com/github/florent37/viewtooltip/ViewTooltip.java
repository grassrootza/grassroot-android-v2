...
public class ViewTooltip {
    ...
    public ViewTooltip text(int textRes) {
        this.tooltip_view.setText(textRes);
        return this;
    }
    ...
    public interface TooltipAnimation {
        void animateEnter(View view, ViewPropertyAnimatorListener animatorListener);

        void animateExit(View view, ViewPropertyAnimatorListener animatorListener);
    }
    ...
    public static class FadeTooltipAnimation implements TooltipAnimation {
        ...
        @Override
        public void animateEnter(View view, ViewPropertyAnimatorListener animatorListener) {
            ViewCompat.setAlpha(view, 0);
            ViewCompat.animate(view).alpha(1).setDuration(fadeDuration).setListener(animatorListener);
        }

        @Override
        public void animateExit(View view, ViewPropertyAnimatorListener animatorListener) {
            ViewCompat.animate(view).alpha(0).setDuration(fadeDuration).setListener(animatorListener);
        }
    }
    ...
    public static class TooltipView extends FrameLayout {
        ...
        public void setText(int textRes) {
            if (childView instanceof TextView) {
                ((TextView) this.childView).setText(textRes);
            }
            postInvalidate();
        }
        ...
        protected void startEnterAnimation() {
            tooltipAnimation.animateEnter(this, new ViewPropertyAnimatorListenerAdapter() {
                @Override
        ...
        protected void startExitAnimation(final ViewPropertyAnimatorListener animatorListener) {
            tooltipAnimation.animateExit(this, new ViewPropertyAnimatorListenerAdapter() {
        ...
        public void remove() {
            startExitAnimation(new ViewPropertyAnimatorListenerAdapter() {
        ...
        public void setupPosition(Rect rect) {
            ...
            if (position == Position.LEFT || position == Position.RIGHT) {
                ...
                if (position == Position.LEFT) {
                    ViewCompat.setTranslationY(this, rect.top + spacingY);
                    ViewCompat.setTranslationX(this,rect.left - getWidth());
                } else {
                    ViewCompat.setTranslationY(this, rect.top + spacingY);
                    ViewCompat.setTranslationX(this,rect.right);
                }
                ...
                if (position == Position.BOTTOM) {
                    ViewCompat.setTranslationY(this, rect.bottom);
                    ViewCompat.setTranslationX(this,rect.left + spacingX);
                } else {
                    ViewCompat.setTranslationY(this, rect.top - getHeight());
                    ViewCompat.setTranslationX(this,rect.left + spacingX);
                }
            }
        }
        ...
        private Path drawBubble(RectF myRect, float topLeftDiameter, float topRightDiameter, float bottomRightDiameter, float bottomLeftDiameter) {
            ...
            final float centerX = viewRect.centerX() - ViewCompat.getX(this);
