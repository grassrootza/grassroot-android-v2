...
public final class AccountGeneral {
    ...
    private static final String ACCOUNT_TYPE = "za.org.grassroot.android";

    // This is the name that appears in the Android 'Accounts' settings.
    private static final String ACCOUNT_NAME = "Offline Storage";
    ...
    public static void createSyncAccount(Context c) {
        ...
        if (manager.addAccountExplicitly(account, null, null)) {
            ...
            final long SYNC_FREQUENCY = 6; // 1 hour (seconds)
