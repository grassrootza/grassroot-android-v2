...
class DatabaseServiceImpl(private val helper: DatabaseHelper) : DatabaseService {
    ...
    override fun updateOrCreateUserProfile(userUid: String, userPhone: String, userDisplayName: String, email: String, userSystemRole: String?): UserProfile {
        val newProfile = UserProfile(userUid, userPhone, userDisplayName, email, userSystemRole)
        try {
